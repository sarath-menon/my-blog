...
A mathematical trick gives us the following closed form equation to directly get the noisy image at any timestep. This is much more efficient than adding noise step by step. Let define  <Latex>$\alpha_t = 1 - \beta_t$</Latex>